...
const REMEDIATION = {
    saas_unreachable:
        'The Bee Flow service is not reachable from this Nextcloud. Test with `curl https://server.dev.beeflow.ai/api/health` from the connector container and whitelist that hostname in your egress firewall.',
